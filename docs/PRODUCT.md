...
| **同行主卡** | 连续天 · 本周/今日分钟 · 通读进度；**无「查看回顾」文案**；**整卡可点** → `/report`；数字口径与回顾页一致 |
...
| **同行主卡** | 连续天 · 时长 · 通读环；**整卡**进 `/report` | **无**「查看回顾」文案或次按钮 |
...
| 项 | 规格 |
|----|------|
| **展示** | 「已同行 N 天」+ 本周或今日分钟 + 通读进度环（轻量） |
| **口径** | 与 `/report`（读经回顾）**完全一致**；点进去数字对得上 |

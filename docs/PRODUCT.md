...
│  ●○○○                                │
├─────────────────────────────────────┤
│  今日 12 分钟 · 本月已读 9 天    [›]  │  ← ③ 一行摘要（可轮换里程碑）
├─────────────────────────────────────┤  ← 折叠线以下（渐进内容 · 无「成长与回忆」标题）
│  [去年今日] 诗篇23·划了线        ›  │  ← 可选记忆卡 ≤1；无素材不渲染
└─────────────────────────────────────┘
```
...
**⑤ 成长钩子 + 稳定落点 + 到底反馈**（2026-07-30 打磨）

> **定稿：** 删除常驻「成长与回忆」section；**不动**每日经文 hero 与今日推荐主逻辑。

| 块 | 内容 | 规则 |
|----|------|------|
| **A 一行摘要** | 默认「今日 X 分钟 · 本月已读 Y 天」；可轮换里程碑 | 常驻 |
| **B 稳定落点** | 小组 / 同行 / 发现（非成长资产） | **常驻 1 块**，保证末屏有落点 |
| **C 记忆卡** | 去年今日 / 就快读完 / 月末年末回顾 | ≤1；无素材不渲染 |
| **D 到底** | 「· 已经到底了 ·」哨兵；底 overscroll 轻弹性 | 不足一屏也露出 |
| **下拉刷新** | 顶橡皮筋 +「松开刷新」；刷新摘要/落点/推荐状态 | 横滑不抢；1.5s 频控；reduced-motion 降级 |

```
今日推荐
│  今日 12 分钟 · 本月已读 9 天    [›]  │  ← A
│  [小组] 新约共读 · 今日 6 人打卡  ›  │  ← B 稳定落点
│  [去年今日] 诗篇23 · 你划了线     ›  │  ← C 可选
│         · 已经到底了 ·               │  ← D
```

> **护栏：** 非红点、非催促；成长资产（连续/徽章/笔记列表）不进首页；底拉 ≠ 顶刷新。

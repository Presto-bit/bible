      ...
      beats: [
        {
          ...
          insight: '跟从地点走完这一幕；点地图站点可看简介。路线为传统示意。',
        },
        {
          id: 'w-egypt',
          media: 'map',
        ...
        },
        {
          ...
          insight: '约把「拯救」接上「同在」：下一幕的会幕，就是神住在中间的空间安排。',
        ...
        },
        {
          ...
          title: '荒野一程 · 收束',
          narration:
            '从歌珊的哀声，到红海开路，再到玛拉、以琳、利非订，最后立在西奈山前：人被领出来，是为了朝见、立约。下一幕走进会幕——神如何住在百姓中间。',
          insight: '本幕路径：哀声 → 开路 → 苦水 → 供应 → 磐石 → 立约。',
        },
      ],
    },
    {
      ...
      beats: [
        ...
        },
        {
          ...
          title: '会幕一程 · 收束',
          narration:
            '外院洁净、圣所日常、至圣所深处、约柜中心——分区不是隔绝好奇，而是教导怎样圣洁地靠近。空间的秩序明白了；下一幕看摩西、亚伦与关键地标，人如何被织进这条拯救线。',
          insight: '本幕路径：外院 → 圣所 → 至圣所 → 约柜 → 「住在中间」。',
        },
      ],
    },
    {
      ...
      beats: [
        ...
        },
        {
          ...
          insight: '出埃及三幕收束在此：路走到山，山指向帐，帐指向那位愿意亲近的神。',
        ...
        },
        {
          ...
          ref: 'EXO 19:6',
          narration:
            '哀声被听见，海路被打开，试验中有供应，山上有约，帐中有同在。出埃及的主线不是「我们多能干」，而是「神要得着一群敬拜他的子民」。',
        ...
        },
        {
          ...
          title: '出埃及故事 · 已走完',
          narration:
            '三幕合拢：荒野显拯救与立约，会幕显同在的空间，人物显软弱仍被使用。从哀声到「住在中间」，敬拜由此开始。你可以分享这一程，或打开出埃及记 14、19、25，对照图册再读一遍。',
          insight: '三幕回顾：出路与立约 → 会幕分区 → 人与地标的脉络。',
        },
      ],
    },
  ],

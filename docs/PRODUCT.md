...
| **足迹 2×2** | 想法 / 划线 / 成就 / 进行中的事（计划优先，否则通读%）；满空同高；预览 ≤1 行 |
...
| 格 | 预览规则（≤1 行） | 点击 | 空状态 |
|----|-------------------|------|--------|
| **想法** | 最新一条截断，或数量 | → `/notes`（想法） | 「写下第一句」 |
| **划线** | 书卷+短句，或数量 | → `/notes`（划线） | 「去读经划线」 |
...
| **回流（P1+）** | 从读经/想法返回且有新内容时，对应格 **轻角标**；点进后清除；非红点催促 |
| **长按（可选 P2）** | 分享该条想法/划线；主路径仍是单击进入 |
...
| **P1** | 足迹有内容感 + 细节打磨 | 2×2 **真实预览**（想法/划线/成就/进行中）；满空同高；本地摘要刷新；常用最终 ≤4；账号未完备改细条；轻回流角标（可选） | 预览与目的地数据一致；无进页卡顿 |

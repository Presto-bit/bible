...
_STATEMENTS: tuple[str, ...] = (
    ...
    """,
    # 038_im_client_msg_id：发送幂等
    "ALTER TABLE direct_message ADD COLUMN IF NOT EXISTS client_msg_id TEXT",
    "ALTER TABLE group_message ADD COLUMN IF NOT EXISTS client_msg_id TEXT",
    """

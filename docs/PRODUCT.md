...
**⑤ 成长钩子**（无分区标题；摘要常驻 + 记忆卡条件露出）

> **定稿（2026-07-30）：** 删除常驻「成长与回忆」section；**不动**每日经文 hero 与今日推荐。连续天 / 徽章 / 笔记摘录 / 本周详情回「我的」与报告，不进首页列表。

| 块 | 内容 | 规则 |
|----|------|------|
| **一行摘要**（常驻） | 默认「今日 X 分钟 · 本月已读 Y 天」；可轮换：就快读完 / 月末回顾窗 / 年末回顾 | 点进报告或续读；与记忆卡同源钩子互斥 |
| **记忆卡**（≤1） | 去年今日（有划线/阅读）· 就快读完（若未进摘要）· 月末/年末回顾 | **无素材不渲染**；无空态笔记/弱成就 |

```
首屏：经文 hero → 今日推荐 → …
│  今日 12 分钟 · 本月已读 9 天    [›]  │  ← 摘要（无 pill）
│  [去年今日] 诗篇23 · 你划了线     ›  │  ← 可选，最多 1 张
```

> **护栏：** 非红点、非催促；同屏成长钩子最多「摘要轮换 + 1 记忆卡」；「就快读完」可带 accent，但仍与 hero/计划高亮互斥原则一致。

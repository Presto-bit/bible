...
_OIA_COMPACT_JSON = (
    '{"summary":"≤55字","sections":['
    '{"title":"经文背景","items":["≤60字"]},'
    '{"title":"经文解释","items":["≤80字","≤80字"]},'
    '{"title":"今日回应","items":["≤50字"]}'
    ']}\n'
    "summary=观察；须完整句；经文解释 2 句：原意+衔接，对象或意图。"
)

_OIA_STANDARD_JSON = (
    '{"summary":"≤55字","sections":['
    '{"title":"经文背景","items":["≤60字","≤60字"]},'
    '{"title":"经文解释","items":["≤70字","≤70字","≤70字"]},'
    '{"title":"今日回应","items":["≤50字","≤50字","≤50字"]}'
    ']}\n'
    "多节经按主题归纳；解释含衔接、原意、对象、意图。"
)
...
_OIA_DEEP_JSON = (
    ...
    '{"title":"经文解释","items":["≤78字","≤78字","≤78字","≤78字"]},'
    '{"title":"今日回应","items":["≤60字","≤60字","≤60字"]}'
    ']}\n'
    "解释 4 条对应：衔接、原意、对象、意图。"
)
